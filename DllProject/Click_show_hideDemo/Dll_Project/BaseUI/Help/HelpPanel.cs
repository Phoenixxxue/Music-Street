...
namespace Dll_Project.BaseUI.Help
{
    public class HelpPanel : DllGenerateBase
    {
        ...
        public override void Start()
        {
            ...
            if (mStaticThings.I != null)
            {
                ...
                {
                    UnityEngine.Object.Destroy(AllImgPanel.GetChild(0).GetChild(0).gameObject);
                }
                else
                {
                    UnityEngine.Object.Destroy(AllImgPanel.GetChild(0).GetChild(1).gameObject);
                }
            }
        }
        ...
        private void ToggleClick(bool isOn)
        {
            if (isOn)
            {
                ...
                helpPanel.transform.parent.parent.GetComponent<Canvas>().sortingOrder = 11;
