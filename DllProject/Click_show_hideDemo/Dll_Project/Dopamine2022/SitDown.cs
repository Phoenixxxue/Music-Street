...
namespace Dll_Project.Dopamine2022
{
    /// <summary>
    /// Chair类
    /// </summary>
    ...
    /// </summary>
    public class SitDown : DllGenerateBase
    {
        /// <summary>
        /// 全场椅子分为三个区域
        /// </summary>
        ChairIndex[] chairIndexes = new ChairIndex[1];
        /// <summary>
        ...
        {
            chairIndexes[0] = new ChairIndex(0, 8);//chairIndexes[0] 其中0要与场景中地面的名字索引相同
